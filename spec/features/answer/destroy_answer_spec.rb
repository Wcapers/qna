  ...
  describe 'Authenticated user' do
    ...
    context 'delete own answer' do
        ...
        scenario 'successful destroy' do
          ...
          click_on I18n.t('answers.destroy_button')

          expect(page).to have_content(I18n.t('answers.destroy.successful_destroy'))
    ...
    context "someone else's answer" do
      context 'in own question' do
        ...
        scenario 'failure destroy' do
          ...
          expect(page).to_not have_link(I18n.t('answers.destroy_button'))
        end
      end
    end
  end
